    ...
    <CartProvider>
      <HashRouter>
        <Routes>
          ...
          {/* 🔒 ==================================================
              🔒 ROUTER-LEVEL BLOCK (CRITICAL FIX)
              🔒 BLOCK FIREBASE EMAIL ACTION LINKS
              ================================================== */}
          <Route path="/vendor/action" element={null} />
          <Route path="/vendor-auth/action" element={null} />
          ...
          {/* ================= VENDOR DASHBOARD ================= */}
          {/* ⚠️ DYNAMIC ROUTES MUST COME AFTER BLOCK */}
